...
Automated Machine Learning Workflow with Makefile
Project Overview
...
make clean
Performance Metrics
After running make evaluate, the system generates a summary of the model's performance. The latest run produced metrics based on:
...
Author
Subhan Shahid BSAI Student @ FAST-NUCES, Aspiring AI & Full-Stack Engineer
